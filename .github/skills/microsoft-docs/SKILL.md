...
| `microsoft\_docs\_search` | Find documentation—concepts, guides, tutorials, configuration |

| `microsoft\_docs\_fetch` | Get full page content (when search excerpts aren't enough) |
